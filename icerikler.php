                                                                ...
                                                                <form action="" method="GET" id="filtreleme" class="form">
                                                                    ...
                                                                    <div class="mb-10">
                                                                        ...
                                                                        <div class="d-flex flex-column flex-wrap fw-semibold">
                                                                            ...
                                                                            <!--begin::Input-->
                                                                            <select class="form-select form-select-solid fw-bold" id="altkonu" name="altkonu" data-kt-select2="true" data-placeholder="Alt Konu" data-allow-clear="true">
                                                                            </select>
                                                                            <!--end::Input-->
                                                                    ...
                                                                    <div class="d-flex justify-content-end">
                                                                        <a href="icerikler"><button type="button" class="btn btn-light btn-active-light-primary me-2">Temizle</button></a>
