                                        ...
                                        <div class="card shadow-lg border-0 rounded-4 bg-light">
                                            <div class="card-body px-4 pt-4 pb-3 d-flex flex-column" style="background-color: #f8f9fa;">
                                                <div class="card-header d-flex justify-content-between align-items-center">
                                                    <h3 class="card-title mb-0">Toplantılar</h3>
                                                                        ...
                                                                        <td>
                                                                            <?php if ($_SESSION['role'] == 1 || $_SESSION['role'] == 10001): ?>
                                                                                <a href="<?= htmlspecialchars($row['zoom_start_url']) ?>" target="_blank" class="btn btn-success btn-sm me-2">
                                                                                    <i class="fas fa-video"></i> Toplantıyı Başlat
                                                                                </a>
                                                        ...
                                                        <form id="meetingForm">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="meetingModalLabel">Yeni Toplantı Başlat</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="meetingClass" class="form-label">Yaş Grubu</label>
                                                ...
                                                <div class="modal fade" id="updateMeetingModal" tabindex="-1" aria-labelledby="updateMeetingModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form id="updateMeetingForm">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="updateMeetingModalLabel">Toplantıyı Düzenle</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Kapat"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="updateMeetingClass" class="form-label">Yaş Grubu</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#meetingTable').on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    title: 'Emin misiniz?',
                    text: "Bu toplantı kalıcı olarak silinecektir!",
                    icon: 'warning',
