        ...
        <div class="modal-content">
            ...
            <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="yas-grubu">
                ...
                <div class="modal-header" id="kt_modal_add_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Yaş Grubu Güncelle</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-semibold mb-2">Yaş Grubu</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" id="name" class="form-control form-control-solid" placeholder="Yaş Grubu" name="name" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--end::Scroll-->
