...
<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="oyunlar">
                <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_add_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Oyun Ekleyin</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" id="name" class="form-control form-control-solid" placeholder="Oyun Adı"
                                name="name" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <select id="classes" name="classes" aria-label="Sınıf Seçiniz" data-control="select2"
                                ...
                                <?php echo $chooseClass->getClassSelectListWithPreschool(); ?>
                            </select>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
