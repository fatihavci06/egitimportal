                            ...
                            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
                                        ...
                                        <li class="breadcrumb-item text-gray-700">Hesabım</li>
                                    </ul>
                                    <h1
                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        <div id="kt_app_content_container" class="app-container container-fluid">
                            <div class="row col-lg-12" >
                                <div class="row gx-5 gx-xl-3 col-lg-3" style="align-items: baseline;">
                                    <div class="card mb-5 mb-xxl-8">
                                        <div class="card-body pt-9 pb-0">
                                            <!-- include profile-card -->
                                            <?php include_once "views/profile/partials/profile-card-stu.php"; ?>
                                            <hr style="margin-top: 2px;">
                                            <div class="d-flex flex-column flex-stack">
                                                <div class="d-flex flex-column flex-grow-1 text-gray-500">
                                                    Üyelik Başlangıç Tarihi -> <?php echo $dateFormat->changeDate($userInfo['subscribed_at']); ?>
                                                </div>
                                                <div class="d-flex flex-column flex-grow-1 text-gray-500">
                                                    Üyelik Bitiş Tarihi -> <?php echo $dateFormat->changeDate($userInfo['subscribed_end']); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex flex-column flex-stack">
                                                <div class="d-flex flex-column flex-grow-1 text-gray-500">
                                                    Son Ziyaret -> <?php $student->showLastLoginForStudentDetails($userInfo['id']); ?>
                                                </div>
                                            </div>
                                ...
                                <div class="row gx-5 gx-xl-9 col-lg-9" style="align-items: baseline;">
                                    ...
                                    <div class="row col-12">
                                        <div class="card mb-5 mb-xl-8" style="margin-left: 12px;">
                                            <ul
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="card mb-5 mb-xl-8">
                                                        ...
                                                        <div class="card-body pt-6">
                                                            <?php $student->showPreschoolLessonsListForStudentDetails($userInfo['id'], $userInfo['class_id'], $userInfo['school_id']); ?>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="dersler">
                                            <div class="row g-5 g-xxl-8">
                                                <?php $student->showPreschoolLessonsListForStudentDetailsPage($userInfo['id'], $userInfo['class_id'], $userInfo['school_id']); ?>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="row mt-4">
                                                                    ...
                                                                    <div class="col-lg-10">
                                                                        ...
                                                                        <select id="lessons" name="lessons"
                                                                            ...
                                                                            $lessons = $chooseLesson->getPreschoolLessonByClassId();
