...
<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="veliler"  enctype="multipart/form-data">
                <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_add_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">Veli Ekleyin</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="row fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-semibold mb-2">Veli Adı</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                        ...
                        <div id="kt_modal_add_customer_billing_info" class="collapse show">
                            ...
                            <div class="d-flex flex-column mb-7 fv-row">
                                <!--begin::Label-->
                                <label class="fs-6 fw-semibold mb-2">
                                    <span class="required">Çocuğu</span>
                                </label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select id="child" name="child" aria-label="Öğrenci Seçiniz" data-control="select2"
                                    data-placeholder="Öğrenci Seçiniz..." data-dropdown-parent="#kt_modal_add_customer"
                                    class="form-select form-select-solid fw-bold">
                                    <option value="">Öğrenci Seçin</option>
                                    <?php $chooseStudent->getStudentForParentsSelectList(); ?>
                                </select>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
