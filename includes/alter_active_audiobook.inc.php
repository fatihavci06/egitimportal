...
require_once "../classes/audio-book.classes.php";

$audiobook_manager= new AudioBooks();

try {
    if (isset($_POST['id'])) {
        $id = (int) $_POST['id'];

        $current_book = $audiobook_manager->getOneAudioBookById($id);
        ...
        $audiobook_manager->updateAudioBookStatus($current_book['id'], $new_status);
        ...
        $audiobook_manager->updateAudioBookStatusArray($ids, 0);
