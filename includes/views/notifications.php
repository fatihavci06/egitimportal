    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
        ...
        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('assets/media/misc/menu-header-bg.jpg')">
            ...
            <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Bildirim ve Duyurular
                ...
                $notificationInfo = $notification->getNotificationsForUsersList($_SESSION['role'], $_SESSION['class_id']);
                $totalNotification = count($notificationInfo);
                $anouncementInfo = $anouncement->getAnnouncementsForUsersList($_SESSION['role'], $_SESSION['class_id']);
