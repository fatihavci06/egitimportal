...
require_once "../classes/doyouknow.php";
...
try {
    if (isset($_POST['id'])) {
        ...
        $current_know = $doyouknowObj->getDoYouKnowById($id);
        ...
        $new_status = !$current_know['is_active'] ? 1 : 0;

        $doyouknowObj->updateKnowStatus($current_know['id'], $new_status);
        ...
        $doyouknowObj->updatKnowStatusArray($ids, 0);
