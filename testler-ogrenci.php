...
?>
    ...
    <body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                                <thead>
                                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="text-end min-w-70px">Çözüm Tarihi</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="fw-semibold text-gray-600">
                                                    <?php $topics->getTestList($_SESSION['class_id']); ?>
                                                </tbody>
                                            </table>
                                            <!--end::Table-->
                                        </div>
        ...
        <script src="assets/js/custom/apps/showtestsstu/list/export.js"></script>
        <script src="assets/js/custom/apps/showtestsstu/list/list.js"></script>
        <script src="assets/js/custom/apps/showtestsstu/add.js"></script>
