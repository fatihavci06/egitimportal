    ...
    <body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
                                        ...
                                        <form class="form" action="#" id="ContentForm">
                                            ...
                                            <div class="row mt-4">
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-4 mt-2" id="unit_div"> <label for="unit_id" class="  form-label">Ünite Adı</label>
                                                    ...
                                                    <div class="col-lg-4 mt-2" id="topic_div"> <label for="topic_id" class="  form-label">Konu Adı</label>
        ...
        <script>
            $(document).ready(function() {
                ...
                function loadLessons(ageGroupId, selectedLessonId = null) {
                    ...
                    $.ajax({
                        ...
                        success: function(lessons) {
                            ...
                            // Yeni: Sayfa ilk yüklendiğinde Türkçe seçiliyse ünite/konu alanlarını gizle
                            if (isTurkishSelected) {
                                $('#unit_div, #topic_div').hide();
                                // Ünite ve Konu değerlerini temizle (update sırasında boş gönderilmesi için)
                                $('#unit_id').val('');
                                $('#topic_id').val('');
                                
                            } else {
                                $('#unit_div, #topic_div').show();
                                // Eğer mevcut bir ders ID'si varsa, ve Türkçe değilse, üniteleri yükle
                                if (selectedLessonId) {
                ...
                if (currentData.main_school_class_id) {
                    ...
                    // Yaş grubu seçili değilse diğerlerini boşalt ve göster
                    $('#lesson_id').html('<option value="">Seçiniz</option><option selected disabled>Önce yaş grubu seçiniz...</option>');
                    $('#unit_id').html('<option value="">Seçiniz</option><option selected disabled>Önce ders seçiniz...</option>');
                    $('#topic_id').html('<option value="">Seçiniz</option><option selected disabled>Önce ünite seçiniz...</option>');
                    $('#unit_div, #topic_div').show();
                ...
                $('#main_school_class_id').on('change', function() {
                    ...
                    // Yaş grubu değişince ünite/konu alanlarını görünür yap (sıfırlanır)
                    $('#unit_div, #topic_div').show();
                ...
                $('#lesson_id').on('change', function() {
                    ...
                    var selectedLessonText = $(this).find('option:selected').text().trim(); // Ders adını al

                    // Yeni: Türkçe dersi kontrolü
        ...
        `;
                ...
                $('#submitForm').on('click', function(e) {
                    ...
                    // content alanı tinymce'den alınıyor
                ...
                tinymce.init({
                    selector: '#content', // tinymce sadece metin içeriği alanına uygulanıyor
                    // diğer ayarlar...
                });
            });
        </script>
