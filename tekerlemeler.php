                ...
                <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                    ...
                    border-top border-bottom border-custom-red mb-2" style="border-width: 5px !important; height:85px;margin-bottom: 26px !important;">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h1 class="fs-3 fw-bold text-dark mb-0">Tekerleme</h1>
                                                </div>
                                            </header>
                                        </div>
                                        ...
                                        <div class="row container-fluid d-flex justify-content-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-5 d-flex ">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-5 d-flex ">
                                                <div class="card w-100 border-0">
                                                    <div class="card-overlay d-flex align-items-center ">
                                                        <img src="uploads/e-kutuphane/berber.png" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
