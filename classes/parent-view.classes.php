...
class ShowParent extends Parents
{
    ...
    public function getParentList()
    {
        ...
        $parentInfo = $this->getParentsList();
        ...
        foreach ($parentInfo as $key => $value) {
            ...
            $parentList = '
                    <tr>
                        ...
                        <td>
                            <a href="tel:' . $value['parentTelephone'] . '" class="text-gray-800 text-hover-primary mb-1">' . $value['parentTelephone'] . '</a>
                        </td>
                        <td>
    ...
    // Get Parent List Select

    public function getParentSelectList()
    {
    ...
    public function showOneParent($slug)
    {

        $parentInfo = $this->getOneParent($slug);
    ...
    public function updateOneParent($slug)
    {
    ...
    public function showParentList()
    {
        ...
        foreach ($parentInfo as $value) {
            ...
            $parentForms = '<div class="form-check">
            ...
            $parentList .=  $parentForms;
        }


        echo $divStart . $parentList . $divEnd;
    }
}
