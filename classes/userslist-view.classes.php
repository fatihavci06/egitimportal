...
class ShowUser extends User
{
                    ...
                    <tr>
                        <td>
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input" type="checkbox" value="' . $value['username'] . '" />
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            ' . $dateFormat->changeDate($value['created_at']) . '
                        </td>
                        <td>
                            ' . $active . '
                        </td>
    ...
    // Get User For Parents List Select

    public function getUserForParentsSelectList()
    {

        $studentInfo = $this->getUsersForParents();
    ...
    public function showOneUser($slug)
    {

        $schoolInfo = $this->getOneUser($slug);
    ...
    public function updateOneUser($slug)
    {
    ...
    public function showUserList()
    {
        ...
        foreach ($schoolInfo as $value) {
            ...
            $userList .=  $schoolForms;
        }


        echo $divStart . $userList . $divEnd;
    }
}
