...
class AddParentContr extends AddParent
{
	...
	public function __construct($photoSize, $photoName, $fileTmpName, $name, $surname, $username, $gender, $birthdate, $email, $telephone, $child, $password)
	{
	...
	public function addParentDb()
	{
		...
		$this->setParent($imgName, $this->name, $this->surname, $this->username, $this->gender, $this->birthdate, $this->email, $this->telephone, $this->child, $this->password);
	}
}
