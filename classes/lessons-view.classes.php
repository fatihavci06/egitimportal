...
class ShowLesson extends Lessons
{
    ...
    public function getLessonList()
    {
        ...
        $lessonsInfo = $this->getLessonsList();
    ...
    public function showOneLesson($slug)
    {

        $lessonsInfo = $this->getOneLesson($slug);
    ...
    public function updateOneLesson($slug)
    {
    ...
    public function showLessonForUnitList($class)
    {
