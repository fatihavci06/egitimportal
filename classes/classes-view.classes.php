...
class ShowClass extends Classes
{
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a href="./ana-okul-detay/' . $value['slug'] . '" class="menu-link px-3">Görüntüle</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row" id="deleteGroup">Pasif Yap</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
    ...
    public function showOneClass($slug)
    {
        ...
        $classInfo = $this->getOneClass($slug);
    ...
    public function updateOneClass($slug)
    {
    ...
    public function showClassList()
    {
        ...
        echo $divStart . $classList . $divEnd;
    }
}
