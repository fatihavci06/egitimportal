...
class AddWrittenBook extends Dbh
{
	...
	protected function setWrittenBook($imgName, $slug, $name, $iframe, $classAdd, $lesson, $unit, $topic, $subtopic)
	{

		$stmt = $this->connect()->prepare('INSERT INTO written_book_lnp SET slug = ?, name = ?, cover_img = ?, book_url=?, class_id=?, lesson_id=?,  unit_id=?, topic_id=?, subtopic_id=?');
	...
	protected function updateWrittenBook($id, $imgName, $slug, $name, $iframe, $classAdd, $lesson, $unit, $topic, $subtopic)
	{
