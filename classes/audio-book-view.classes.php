...
class ShowAudioBooks extends AudioBooks
{
    ...
    public function getGamesListStudent()
    {

        $unitInfo = $this->getAudioBooksList();
    ...
    // Get Game Image For Students

    public function getHeaderImageStu()
    {

        $unitInfo = $this->getAudioBooksListImage();
        ...
        foreach ($unitInfo as $key => $value) {
            ...
            $lessonList = '
                    <div class="position-relative mb-17">
                        ...
                        <div class="overlay overlay-show">
                            <!--begin::Image-->
                            <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-250px" style="background-image:url(\'assets/media/sesli-kitap/sesli-kitap-1-75713.jpg\')"></div>
                            <!--end::Image-->
                            <!--begin::layer-->
                            <div class="overlay-layer rounded bg-black" style="opacity: 0.4"></div>
                            <!--end::layer-->
    ...
    // Get Games Topics Sidebar For Students
    ...
    public function showOneGame($slug)
    {
        ...
        $unitInfo = $this->getOneAudioBook($slug);
    ...
    public function updateOneGame($slug)
    {
        ...
        foreach ($unitInfo as $key => $value) {
            ...
            $lessonList = '
                    ...
                    <div class="m-0">
                        ...
                        <!--end::Title-->
                        <!--begin::Text-->
                        <p class="fw-semibold fs-4 text-gray-600 mb-2">' . $value['book_url'] . '</p>
                        <!--end::Text-->
                    </div>
                ';
            echo $lessonList;
