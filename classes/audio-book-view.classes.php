...
class ShowAudioBook extends AudioBooks
{
    ...
    public function showOneAudioBook($slug)
    {
        ...
        $bookHtml = '
                <tr>
                    <td>
                        <a href="./sesli-kitap-detay/' . $audioBookInfo['slug'] . '" class="cursor-pointer symbol symbol-90px symbol-lg-90px">
                            <img src="assets/media/sesli-kitap/' . $audioBookInfo['cover_img'] . '" alt="' . $audioBookInfo['book_name'] . '">
                        </a>
                    </td>
                    <td>
                        <a href="./sesli-kitap-detay/' . $audioBookInfo['slug'] . '" class="text-gray-800 text-hover-primary mb-1 fw-bold">' . $audioBookInfo['book_name'] . '</a>
                    </td>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 
                            ...
                            <div class="menu-item px-3">
                                <a href="./sesli-kitap-detay/' . $audioBookInfo['slug'] . '" class="menu-link px-3">Görüntüle</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Pasif Yap</a>
                            </div>
