...
class ContentTracker
{
    ...
    public function getPreschoolContentAnalyticsByTopicId($user_id, $class_id, $lesson_id, $unit_id, $topic_id)
    {
        $sql = "
            SELECT 
                sc.id as content_id,
            ...
            WHERE sc.status = 1 AND sc.main_school_class_id = ? AND sc.lesson_id = ? AND sc.unit_id = ?  AND sc.topic_id = ?
