...
class ShowPackagesForAdmin extends PackagesForAdmin
{
    ...
    public function showAllPackages()
    {
        ...
        foreach ($packageInfo as $value) {
            ...
            if ($status === 0) {
                $statusButton = '
            <a href="javascript:void(0);" class="menu-link px-3 btn btn-success btn-sm"
...
class ShowSchoolarshipPackagesForAdmin extends PackagesForAdmin
{

    // Get Packages For Admin

    public function showAllSchoolarshipPackages()
    {

        $packageInfo = $this->getAllSchoolarshipPackages();
