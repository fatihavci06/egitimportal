...
class ShowAnnouncement extends Announcement
{
    ...
    public function getAnnouncementList()
    {
        ...
        $announcementInfo = $this->getAnnouncementsList();
        ...
        foreach ($announcementInfo as $key => $value) {
            ...
            if($value['toAll'] == 1){
                ...
                $toWhom = $this->getAnnouncementsClass($value['class_id']);
            }elseif ($value['role_id'] != 0) {
                $toWhom = $this->getAnnouncementsRole($value['role_id']);
            }
    ...
    public function getAnnouncementForStudentList($role, $class_id)
    {
        ...
        $announcementInfo = $this->getAnnouncementsForStudentList($role, $class_id);
        ...
        foreach ($announcementInfo as $key => $value) {
            ...
            $announcementList = '
                    <tr>
                        ...
                        <td>
                            <a href="./duyuru/' . $value['slug'] . '" class="text-gray-800 text-hover-primary mb-1">' . $value['name'] . '</a>
                        </td>
                        <td>
                            ' . $value['content'] . '
                        </td>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="./duyuru/' . $value['slug'] . '" class="menu-link px-3">Görüntüle</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
    ...
    // Get Announcement List Select

    public function getAnnouncementSelectList()
    {
    ...
    public function showOneAnnouncement($slug)
    {
        ...
        $announcementInfo = $this->getOneAnnouncement($slug);
    ...
    public function showAnnouncementList()
    {
        ...
        $announcementInfo = $this->getAnnouncements();
        ...
        foreach ($announcementInfo as $value) {
            ...
            $announcementList .=  $schoolForms;
        }


        echo $divStart . $announcementList . $divEnd;
    }
}

class ShowAnnouncementForUsers extends AnnouncementForUsers
{

    // Get AnnouncementForUsers List

    public function getAnnouncementForUsersList()
    {

        $announcementInfo = $this->getAnnouncementsForUsersList($_SESSION['role'], $_SESSION['class_id'], $_SESSION['id']);
        ...
        foreach ($announcementInfo as $key => $value) {
            ...
            if($value['toAll'] == 1){
                ...
                $toWhom = $this->getAnnouncementsForUsersClass($value['class_id']);
            }elseif ($value['role_id'] != 0) {
                $toWhom = $this->getAnnouncementsForUsersRole($value['role_id']);
            }
    ...
    // Get AnnouncementForUsers List Select

    public function getAnnouncementForUsersSelectList()
    {
    ...
    // Show AnnouncementForUsers

    public function showOneAnnouncementForUsers($slug)
    {

        $announcementInfo = $this->getOneAnnouncementForUsers($slug);
    ...
    // Update AnnouncementForUsers

    public function updateOneAnnouncementForUsers($slug)
    {
    ...
    // List of AnnouncementsForUsers

    public function showAnnouncementForUsersList()
    {

        $announcementInfo = $this->getAnnouncementsForUsers();
...
class ShowNotification extends Notification
{
    ...
    public function getNotificationList()
    {
        ...
        $notificationInfo = $this->getNotificationsList();
        ...
        foreach ($notificationInfo as $key => $value) {
            ...
            if($value['toAll'] == 1){
                ...
                $toWhom = $this->getNotificationsClass($value['class_id']);
            }elseif ($value['role_id'] != 0) {
                $toWhom = $this->getNotificationsRole($value['role_id']);
            }
    ...
    // Get Notification List Select

    public function getNotificationSelectList()
    {
    ...
    public function showOneNotification($slug)
    {
        ...
        $notificationInfo = $this->getOneNotification($slug);
    ...
    public function updateOneNotification($slug)
    {
    ...
    public function showNotificationList()
    {
        ...
        $notificationInfo = $this->getNotifications();
        ...
        foreach ($notificationInfo as $value) {
            ...
            $notificationList .=  $schoolForms;
        }


        echo $divStart . $notificationList . $divEnd;
    }
}

class ShowNotificationForUsers extends NotificationForUsers
{

    // Get NotificationForUsers List

    public function getNotificationForUsersList()
    {

        $notificationInfo = $this->getNotificationsForUsersList($_SESSION['role'], $_SESSION['class_id']);
        ...
        foreach ($notificationInfo as $key => $value) {
            ...
            if($value['toAll'] == 1){
                ...
                $toWhom = $this->getNotificationsForUsersClass($value['class_id']);
            }elseif ($value['role_id'] != 0) {
                $toWhom = $this->getNotificationsForUsersRole($value['role_id']);
            }
    ...
    // Get NotificationForUsers List Select

    public function getNotificationForUsersSelectList()
    {
    ...
    // Show NotificationForUsers

    public function showOneNotificationForUsers($slug)
    {

        $notificationInfo = $this->getOneNotificationForUsers($slug);
    ...
    // Update NotificationForUsers

    public function updateOneNotificationForUsers($slug)
    {
    ...
    // List of NotificationForUserss

    public function showNotificationForUsersList()
    {

        $notificationInfo = $this->getNotificationsForUsers();
