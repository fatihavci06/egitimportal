...
class AddUser extends Dbh
{
	...
	public function setParent($kullanici_ad, $kullanici_soyad, $username, $password2, $parentRole)
	{
		...
		if (!$stmt->execute([$kullanici_ad, $kullanici_soyad, $username, $password2, $parentRole, "1", $lastId])) {
			$stmt = null;
			//header("location: ../admin.php?error=stmtfailed");
			exit();
		}
