                                        ...
                                        <div class="card-header border-0 pt-6">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <div class="d-flex justify-content-end"
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px"
                                                            ...
                                                            <div class="px-7 py-5">
                                                                <form action="" method="GET" id="filtreleme" class="form">
                                                                    ...
                                                                    <!--begin::Actions-->
                                                                    <div class="d-flex justify-content-end">
                                                                        <a href="alt-konular"><button type="button"
                                                    ...
                                                    <!--begin::Add school-->
                                                    <a
                                                        href="altkonu-ekle?return_url=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>"><button
                                                            type="button" class="btn btn-primary btn-sm h-100">Alt Konu
                                                            Ekle</button></a>
                                                    <!--end::Add school-->
                                                </div>
                                                <!--end::Toolbar-->
