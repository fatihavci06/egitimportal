                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                    <div class="card-body pt-5 ">
                                        ...
                                        <div class="row container-fluid" style="margin-top:-25px;">
                                            <header class="container-fluid bg-custom-light py-3 d-flex justify-content-between align-items-center
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h1 class="fs-3 fw-bold text-dark mb-0"><?= $_GET['month']??'-' ?></h1>
                                        ...
                                        <?php
                                        // VERİ HAZIRLIĞI
                                        $monthId = $_GET['month'] ?? 1;
                                        $contentList = $dataList->getMontBasedContentList($monthId);

                                        // Sabit görsel URL'si
                                        $defaultImageUrl = 'uploads/contents/konuDefault.jpg';

                                        if (empty($contentList)) {
                                            echo '<div class="alert alert-info text-center mt-4" role="alert">Bu aya ait içerik bulunmamaktadır.</div>';
                                            return;
                                        }
                                        ?>
