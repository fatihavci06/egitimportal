...
?>
    ...
    <body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
                                ...
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                        ...
                                        <div class="card-header border-0 pt-6">
                                            ...
                                            <div class="card-title">
                                                ...
                                                <div class="d-flex align-items-center position-relative my-1">
                                                    ...
                                                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Öğretmen Ara" />
                                                </div>
                                                <!--end::Search-->
                                            </div>
                                            <!--begin::Card title-->
                                    ...
                                    <?php if ($_SESSION['role'] == 1) {
                                        include_once "views/teacher/add_teacher.php";
                                    } else {
                                        include_once "views/teacher/add_teacher_school.php";
                                    } ?>
        ...
        <script src="assets/js/custom/apps/teachers/list/export.js"></script>
        <script src="assets/js/custom/apps/teachers/list/list.js"></script>
        <script src="assets/js/custom/apps/teachers/add.js"></script>
