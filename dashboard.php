...
if (isset($_SESSION['role']) and ($_SESSION['role'] == 1 or $_SESSION['role'] == 2 or $_SESSION['role'] == 3 or $_SESSION['role'] == 4 or $_SESSION['role'] == 5 or $_SESSION['role'] == 8 or $_SESSION['role'] == 9 or $_SESSION['role'] == 10 or $_SESSION['role'] == 10001 or $_SESSION['role'] == 10002 or $_SESSION['role'] == 10005 or $_SESSION['role'] == 20001)) {
	...
	<body id="kt_app_body" class="dashLand" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true"
												...
												<div class="card card-flush h-xl-100">
													...
													<div class="card-header pt-5">
														...
														<h3 class="card-title align-items-start flex-column">
															<span class="card-label fw-bold text-gray-900">Performans Genel
																Bakışı</span>
															<span class="text-gray-500 mt-1 fw-semibold fs-6">Tüm öğrenciler
																arasında</span>
														</h3>
														<!--end::Title-->
														<!--begin::Toolbar-->
															...
															<ul class="nav" id="kt_chart_widget_8_tabs">
																<li class="nav-item">
																	<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1"
																		...
																		href="#kt_chart_widget_8_week_tab">Ay</a>
																</li>
																<li class="nav-item">
																	<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 active"
																		...
																		href="#kt_chart_widget_8_month_tab">Hafta</a>
																</li>
															</ul>
														</div>
														<!--end::Toolbar-->
														...
														<div class="tab-content">
															...
															<div class="tab-pane fade" id="kt_chart_widget_8_week_tab"
																...
																<div class="mb-5">
																	...
																	<div class="d-flex align-items-center mb-2">
																		<span
																			class="fs-3x fw-bold text-gray-800 me-2 lh-1 ls-n2">6</span>
																		<span
																			class="fs-1 fw-semibold text-gray-500 me-1 mt-n1">Saat</span>
																	...
																	<!--end::Statistics-->
																	<!--begin::Description-->
																	<span class="fs-6 fw-semibold text-gray-500">Ortalama
																		geçirilen süre</span>
																	<!--end::Description-->
																</div>
																<!--end::Statistics-->
																...
																<div class="d-flex flex-wrap pt-5">
																	...
																	<div class="d-flex flex-column me-7 me-lg-16 pt-sm-3 pt-6">
																		...
																		<div class="d-flex align-items-center mb-3 mb-sm-6">
																			...
																			<!--end::Bullet-->
																			<!--begin::Label-->
																			<span class="fw-bold text-gray-600 fs-6">A
																				Öğrencisi</span>
																			<!--end::Label-->
																		</div>
																		<!--ed::Item-->
																		...
																		<div class="d-flex align-items-center">
																			...
																			<!--end::Bullet-->
																			<!--begin::Label-->
																			<span class="fw-bold text-&lt;gray-600 fs-6">B
																				Öğrencisi</span>
																			<!--end::Label-->
																		</div>
																		<!--ed::Item-->
																	...
																	<div class="d-flex flex-column me-7 me-lg-16 pt-sm-3 pt-6">
																		...
																		<div class="d-flex align-items-center mb-3 mb-sm-6">
																			...
																			<!--end::Bullet-->
																			<!--begin::Label-->
																			<span class="fw-bold text-gray-600 fs-6">C
																				Öğrencisi</span>
																			<!--end::Label-->
																		</div>
																		<!--ed::Item-->
																		...
																		<div class="d-flex align-items-center">
																			...
																			<!--end::Bullet-->
																			<!--begin::Label-->
																			<span class="fw-bold text-gray-600 fs-6">D
																				Öğrencisi</span>
																			<!--end::Label-->
																		</div>
																		<!--ed::Item-->
																	...
																	<div class="d-flex flex-column me-7 me-lg-16 pt-sm-3 pt-6">
																		...
																		<div class="d-flex align-items-center mb-3 mb-sm-6">
																			...
																			<!--end::Bullet-->
																			<!--begin::Label-->
																			<span class="fw-bold text-gray-600 fs-6">E
																				Öğrencisi</span>
																			<!--end::Label-->
																		</div>
																		<!--ed::Item-->
																		...
																		<div class="d-flex align-items-center">
																			...
																			<!--end::Bullet-->
																			<!--begin::Label-->
																			<span class="fw-bold text-gray-600 fs-6">F
																				Öğrencisi</span>
																			<!--end::Label-->
																		</div>
																		<!--ed::Item-->
															...
															<div class="tab-pane fade active show"
																...
																<div class="mb-5">
																	...
																	<div class="d-flex align-items-center mb-2">
																		<span
																			class="fs-3x fw-bold text-gray-800 me-2 lh-1 ls-n2">5,5</span>
																		<span
																			class="fs-1 fw-semibold text-gray-500 me-1 mt-n1">Saat</span>
																		<span class="badge badge-light-success fs-base">
																			<i
											...
											<div class="col-xl-6 mb-5 mb-xl-10">
												...
												<div class="card card-flush h-xl-100">
													...
													<div class="card-header pt-5">
														<!--begin::Title-->
														<h3 class="card-title align-items-start flex-column">
															<span class="card-label fw-bold text-gray-800">Öğrenci
																Başarıları</span>
															<span class="text-gray-500 mt-1 fw-semibold fs-6">Ortalama %84
																Başarı</span>
														</h3>
														<!--end::Title-->
													</div>
														...
														<ul class="nav nav-pills nav-pills-custom mb-3">
															...
															<li class="nav-item mb-3 me-3 me-lg-6">
																...
																<a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2 active"
																	...
																	<!--begin::Title-->
																	<span
																		class="nav-text text-gray-800 fw-bold fs-6 lh-1">Türkçe</span>
																	<!--end::Title-->
																	<!--begin::Bullet-->
																	<span
															...
															<li class="nav-item mb-3 me-3 me-lg-6">
																...
																<a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
																	...
																	<!--begin::Title-->
																	<span
																		class="nav-text text-gray-800 fw-bold fs-6 lh-1">Matematik</span>
																	<!--end::Title-->
																	<!--begin::Bullet-->
																	<span
																		class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
															...
															<li class="nav-item mb-3 me-3 me-lg-6">
																...
																<a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
																	...
																	<!--begin::Title-->
																	<span
																		class="nav-text text-gray-800 fw-bold fs-6 lh-1">İngilizce</span>
																	<!--end::Title-->
																	<!--begin::Bullet-->
																	<span
																		class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
																					...
																					<div class="d-flex align-items-center">
																						...
																						<div
																							...
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">T
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								1</span>
																						</div>
																					</div>
																				</td>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">F
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								2</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">R
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								1</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">U
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								8</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">D
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								5</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Y
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								3</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">P
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								2</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">H
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								4</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">J
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								1</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">C
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								5</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">A
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								5</span>
																				...
																				<td>
																					<div class="d-flex align-items-center">
																						...
																						<div
																							class="d-flex justify-content-start flex-column">
																							<a href="pages/user-profile/overview.html"
																								class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ş
																								Öğrencisi</a>
																							<span
																								class="text-gray-500 fw-semibold d-block fs-7">Okul
																								2</span>
