									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column gap-1 me-3 mb-2">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-700 fw-bold lh-1">Alt Konu Detay</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-1 lh-0">Alt Konu Detay</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
									</div>
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-fluid">
									...
									<div class="d-flex flex-column flex-xl-row">
										<!--begin::Sidebar-->
										<?php $subTopics->showOneSubTopic($slug); ?>
										<!--end::Sidebar-->
										<!--begin::Content-->
										<div class="flex-lg-row-fluid ms-lg-15">
											...
											<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
												<!--begin:::Tab item-->
												<li class="nav-item">
													<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#konular">İçerikler</a>
												</li>
												<!--end:::Tab item-->
												<!--end:::Tab item-->
												<!--begin:::Tab item-->
													...
													<div class="card pt-4 mb-6 mb-xl-9">
														...
														<div class="card-body pt-0 pb-5">
															...
															<div class="d-flex align-items-center position-relative my-1">
																...
																<input type="text" data-kt-table-customers-payment-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="İçerik Ara" />
															</div>
															<!--end::Search-->
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																<thead class="border-bottom border-gray-200 fs-7 fw-bold">
																	<tr class="text-start text-muted text-uppercase gs-0">
																		<th class="min-w-100px">İçerik Adı</th>
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<?php
																		$subTopics->showContentsListForSubTopicDetail($slug); 
																	?>
																</tbody>
																<!--end::Table body-->
															</table>
