...
if (isset($_SESSION['role']) and $_SESSION['role'] == 1) {
    ...
    $announce_manager = new NotificationManager();
    ...
    // $notify->getAnnouncementStats($notify_data['id']); 
    ?>
    ...
    <body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true"
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                <?php $notify->getNotificaionStats($notify_data['id']); ?>
                                            </tbody>
                                        </table>
                                        <!--end::Table-->
                                    </div>
        ...
        <script src="assets/js/custom/apps/notification-stats/list/export.js"></script>
        <script src="assets/js/custom/apps/notification-stats/list/list.js"></script>
