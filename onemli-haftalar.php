                                ...
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header border-0 pt-6">
                                            ...
                                            <div class="card-title">
                                                ...
                                                <div class="d-flex align-items-center position-relative my-1">
                                                    ...
                                                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Önemli Hafta Ara" />
                                                </div>
                                                <!--end::Search-->
                                            </div>
                                            <!--begin::Card title-->
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                                    <!--begin::Add school-->
                                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Önemli Hafta Ekle</button>
                                                    <!--end::Add school-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="weekModalUpdate" tabindex="-1" aria-labelledby="weekModalUpdateLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="weekModalUpdateLabel">Güncelle</h5>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-primary btn-sm" onclick="updateWeek(currentId)">Güncelle</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <script>
                                                const weekModalUpdate = document.getElementById('weekModalUpdate');
                                                let currentId = null; // İd'yi global olarak tutacağız

                                                weekModalUpdate.addEventListener('show.bs.modal', function(event) {
                                                    ...
                                                    fetch('includes/ajax.php?service=importantWeekShow&id=' + encodeURIComponent(currentId))
