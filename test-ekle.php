...
?>
    ...
    <body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
                        ...
                        <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
                                ...
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                    <!--begin::Card-->
                                    <?php include_once "views/tests/add_test.php"; ?>
                                    <!--end::Card-->
                                </div>
        ...
        <script src="assets/js/custom/apps/tests/list/export.js"></script>
        <script src="assets/js/custom/apps/tests/list/list.js"></script>
       <!-- <script src="assets/js/custom/apps/tests/list/topicadd.js"></script>-->
        <script src="assets/js/custom/apps/tests/add.js"></script>
        <script src="assets/js/custom/apps/tests/create.js"></script>
