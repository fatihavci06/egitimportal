const radios = document.getElementsByName('discount_type');
const couponForm = document.querySelector("#couponForm");
const discountValue = document.querySelector("#discount_value")
const couponCodeContainer = document.querySelector("#couponCodeContainer")
const couponCode = document.querySelector("#coupon_code")
const generateCouponButton = document.querySelector("#generate_coupon")
let selected;
...
// generateCouponButton.addEventListener("click",function(){
...
//                         validators: {
//                             notEmpty: {
//                                 message: 'İndirim değeri zorunlu'
//                             }
//                         }
//                     },
//                 },
