...
var KTCustomersList = function () {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const soruGruplari = document.querySelectorAll('[data-kt-element="item"]');
    
        soruGruplari.forEach(function(soruGrubu) {
          const checkboxes = soruGrubu.querySelectorAll('input[type="checkbox"]');
    
          checkboxes.forEach(function(checkbox) {
            checkbox.addEventListener('change', function() {
              const ayniGruptakiCheckboxlar = soruGrubu.querySelectorAll('input[type="checkbox"].' + this.classList[1]);
    
              ayniGruptakiCheckboxlar.forEach(function(cb) {
                if (cb !== checkbox) {
                  cb.checked = false;
                }
              });
