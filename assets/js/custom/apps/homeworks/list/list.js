    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: customerName + " isimli ödevi " + activeStatus + " yapmak istediğinizden emin misiniz?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "includes/update_active_homework.inc.php",
                            data: {
                                id: fileId,
                                statusVal: statusVal,
                            },
                            ...
                            success: function (response) {
                                if (response.status === "success") {
                                    ...
                                    Swal.fire({
                                        text: customerName + " adlı ödevi " + activeStatus + " hale gelmiştir!.",
                                        icon: "success",
                                        buttonsStyling: false,
