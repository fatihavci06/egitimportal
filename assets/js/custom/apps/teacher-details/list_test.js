...
var KTTest = function () {
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-kt-test-table-filter="search"]');
    ...
    var handleFilterDatatable = () => {
        ...
        filterStatus = $('[data-kt-test-table-filter="status"]');
        filterSchool = $('[data-kt-test-table-filter="school"]');
        filterClass = document.querySelectorAll('[data-kt-test-table-filter="student_class"] [name="student_class"]');
        const filterButton = document.querySelector('[data-kt-test-table-filter="filter"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-kt-test-table-filter="delete_row"]');
    ...
    const toggleToolbars = () => {
        // Define variables
        const toolbarBase = document.querySelector('[data-kt-test-table-toolbar="base"]');
        const toolbarSelected = document.querySelector('[data-kt-test-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-kt-test-table-select="selected_count"]');
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_test_table');
