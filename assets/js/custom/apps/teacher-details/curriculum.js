...
var KTStudentProgress = function () {
    ...
    var initForm = function () {
        ...
        submitButton.addEventListener('click', function (e) {
            ...
            setTimeout(function () {
                const form = document.getElementById('kt_form_curriculum');
                ...
                $.ajax({
                    type: "POST",
                    url: "includes/get_curriculum.inc.php",
                    data: formData,
                    contentType: false,
                    processData: false,
                    dataType: "json",
    ...
    return {
        init: function () {
            ...
            form = document.querySelector('#kt_form_curriculum');
            submitButton = document.querySelector('#kt_form_curriculum_submit');
            initForm();
        }
    };
}();
