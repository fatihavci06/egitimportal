...
var KTCustomersList = function () {
    ...
    var initCustomerList = function () {
        ...
        tableRows.forEach(row => {
            ...
            const realDate = moment(dateRow[7].innerHTML, "DD MMM YYYY, LT").format(); // select date from 3rd column in table
            dateRow[7].setAttribute('data-order', realDate);
        });
        ...
        datatable = $(table).DataTable({
            ...
            'order': [],
            'columnDefs': [
                { orderable: false, targets: 0 }, // Disable ordering on column 0 
                { orderable: false, targets: 4 }, // Disable ordering on column 5
            ]
        });
