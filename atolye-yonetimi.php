                                        ...
                                        <div class="card-header border-0 pt-6">
                                            ...
                                            <div class="card-toolbar">
                                                <div class="d-flex justify-content-end me-2" data-kt-customer-table-toolbar="base">
                                                    <a href="atolye-toplanti-ekle" class="btn btn-primary btn-sm">
                                                        <i class="fas fa-calendar-plus"></i>&nbsp; Toplantı Planla
                                                    </a>
                                                </div>

                                                <div class="d-flex justify-content-end me-2" data-kt-customer-table-toolbar="base">
                                                    <a href="atolye-icerik-ekle" class="btn btn-primary btn-sm">
                                                ...
                                                <tbody class="fw-semibold text-gray-600">
                                                    ...
                                                    if (!empty($contentLists)) {
                                                        foreach ($contentLists as $content) {
                                                            ...
                                                            $displaySecimType = $secimTypeMap[$content['secim_type']] ?? 'Zoom Toplantısı';
            ...
            $(document).ready(function() {
                ...
                $('#atolyeIcerikleri').on('click', '.toggle-content-status', function(e) {
                    ...
                    Swal.fire({
                        ...
                        text: newStatus == 1 ?
                            "Bu içeriği aktif hale getirmek istediğinize emin misiniz?" : "Bu içeriği pasif hale getirmek istediğinize emin misiniz?",
                        icon: 'question',
