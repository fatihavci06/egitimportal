...
session_start();
define('GUARD', true);
if (isset($_SESSION['role']) and ($_SESSION['role'] == 1 or $_SESSION['role'] == 3 or $_SESSION['role'] == 10002 or $_SESSION['role'] == 2)) {
    ...
    $writtenBookObj = new ShowWrittenBook();
    ...
    <body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true"
                                        ...
                                        <div class="card-body p-lg-7">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                ...
                                                <tbody class="fw-semibold text-gray-600">
                                                    <?php $writtenBookObj->showOneWrittenBook($writtenBook_slug) ?>
                                                </tbody>
                                            </table>
                                            <!--end::Table-->
                                        </div>
                                                            ...
                                                            <div class="image-input image-input-outline image-input-placeholder image-input-empty image-input-empty"
                                                                ...
                                                                <label
                                                                    ...
                                                                    <input type="file" name="photo" id="photo"
                                                                        ...
                                                                        value="<?php echo $writtenBook_slug; ?>" />
        ...
        <script src="assets/js/custom/apps/written-book/update.js"></script>
