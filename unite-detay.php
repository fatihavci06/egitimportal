...
?>
	...
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column gap-1 me-3 mb-2">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-700 fw-bold lh-1">Ünite Detay</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-1 lh-0">Ünite Detay</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
									</div>
									...
									<div class="d-flex flex-column flex-xl-row">
										...
										<div class="flex-lg-row-fluid ms-lg-15">
											...
											<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
												<!--begin:::Tab item-->
												<li class="nav-item">
													<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#konular">Konular</a>
												</li>
												<!--end:::Tab item-->
												<!--begin:::Tab item-->
												<li class="nav-item">
													<a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#alt_konular">Alt Konular</a>
												</li>
												<!--end:::Tab item-->
												<!--begin:::Tab item-->
												<!--<li class="nav-item">
											...
											<div class="tab-content" id="myTabContent">
													...
													<div class="card pt-4 mb-6 mb-xl-9">
														...
														<div class="card-body pt-0 pb-5">
															...
															<div class="d-flex align-items-center position-relative my-1">
																...
																<input type="text" data-kt-table-customers-payment-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Konu Ara" />
															</div>
															<!--end::Search-->
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<?php $topics->showTopicsListForUnitDetail($slug); ?>
																</tbody>
																<!--end::Table body-->
															</table>
															<!--end::Table-->
												...
												<!--end:::Tab pane-->
												<!--begin:::Tab pane-->
												<div class="tab-pane fade" id="alt_konular" role="tabpanel">
													<!--begin::Card-->
													<!--begin::Card-->
													<div class="card pt-4 mb-6 mb-xl-9">
														<!--begin::Card header-->
														...
														<div class="card-body pt-0 pb-5">
															...
															<div class="d-flex align-items-center position-relative my-1">
																...
																<input type="text" data-kt-table-teachers-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Alt konu Ara" />
															</div>
															<!--end::Search-->
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_teachers">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<?php $subTopics->showSubTopicsListForUnitDetail($slug); ?>
																</tbody>
																<!--end::Table body-->
															</table>
															<!--end::Table-->
        ...
        <script src="assets/js/custom/apps/units/guncelle.js"></script>
