...
if (isset($_SESSION['role']) and ($_SESSION['role'] == 1 or $_SESSION['role'] == 10001)) {
    ...
    $coupon = $addCoupon->getCouponWithId($id);
?>
    <!--end::Head-->
    <!--begin::Body-->
                                ...
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                    ...
                                    <form id="coupon_form">
                                        ...
                                        <div class="fv-row radios mb-5">
                                            ...
                                            <label class="form-check-label"><input type="radio" class="mx-2 form-check-input" name="discount_type" id="discount_type_percent" value="percentage" <?=$coupon['discount_type'] === 'percentage' ? 'checked' : ''?>> Yüzde</label>
                                            <label class="form-check-label"><input type="radio" class="mx-2 form-check-input" name="discount_type" id="discount_type_amount" value="amount" <?=$coupon['discount_type'] === 'amount' ? 'checked' : ''?>>TL</label>
                                        </div>
                                        <div class="fv-row mb-2">
                                            <label class="form-label fw-bold text-gray-900 fs-6">İndirim Değeri</label>
                                            <input type="text" id="discount_value" name="discount_value" class="form-control" value="<?= $coupon['discount_value'] ?>" />
                                        </div>
                                        <div class="fv-row mb-2">
                                            <label class="form-label fw-bold text-gray-900 fs-6">Kupon Adedi</label>
                                            <input type="text" id="coupon_quantity" name="coupon_quantity" class="form-control" value="<?= $coupon['coupon_quantity'] ?>" />
                                        </div>
                                        <div class=" fv-row mb-2">
                                            <label class="form-label fw-bold text-gray-900 fs-6">Kupon Tarihi</label>
                                            <input type="date" id="coupon_expires" name="coupon_expires" id="coupon_expires" class="form-control" value="<?= $coupon['coupon_expires'] ?>" />
                                        </div>
                                        <div class="fv-row mb-2">
