...
if (isset($_SESSION['role']) and $_SESSION['role'] == 1) {
	...
	include_once "classes/content-view.classes2.php";
...
?>
	...
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column gap-1 me-3 mb-2">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-700 fw-bold lh-1">İçerik Güncelle</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-1 lh-0">İçerik Güncelle</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
									</div>
									...
									<div class="d-flex flex-column flex-xl-row">
										...
										<div class="flex-lg-row-fluid">
											...
											<div class="tab-content" id="myTabContent">
												<form class="form" action="#" id="ContentForm" data-kt-redirect="icerikler">
													<!--begin:::Tab pane-->
													<div class="tab-pane fade show active" id="konular" role="tabpanel">
														<!--begin::Card-->
														<div class="card pt-4 mb-6 mb-xl-9">
															<?php $contents->showOneContentForUpdate($slug); ?>
														</div>
														<!--end::Card-->
													</div>
													<!--end:::Tab pane-->
													<div class="row mt-5">
														<div class="col-lg-12">
															<button type="button" id="submitForm" class="btn btn-primary btn-sm">Güncelle</button>
														</div>
													</div>
												</form>
											</div>
		...
		<script src="assets/js/custom/apps/content-update/guncelle.js"></script>
