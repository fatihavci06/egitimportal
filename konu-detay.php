...
if (isset($_SESSION['role']) and ($_SESSION['role'] == 1 OR $_SESSION['role'] == 8 OR $_SESSION['role'] == 3 OR $_SESSION['role'] == 4)) {
	...
	$subOrContent = $topics->getTabTitles($slug);
...
?>
	...
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column gap-1 me-3 mb-2">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-6">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-700 fw-bold lh-1">Konu Detay</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-1 lh-0">Konu Detay</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
									</div>
									...
									<div class="d-flex flex-column flex-xl-row">
										...
										<div class="flex-lg-row-fluid ms-lg-15">
											...
											<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
												<!--begin:::Tab item-->
												<li class="nav-item">
													<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#konular"><?php echo $subOrContent; ?></a>
												</li>
												<!--end:::Tab item-->
												<!--end:::Tab item-->
												<!--begin:::Tab item-->
													...
													<div class="card pt-4 mb-6 mb-xl-9">
														...
														<div class="card-header border-0">
															...
															<div class="card-title">
																<h2><?php echo $subOrContent; ?> Listesi</h2>
															</div>
															<!--end::Card title-->
														</div>
														<!--end::Card header-->
														...
														<div class="card-body pt-0 pb-5">
															...
															<div class="d-flex align-items-center position-relative my-1">
																...
																<input type="text" data-kt-table-customers-payment-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="<?php echo $subOrContent; ?> Ara" />
															</div>
															<!--end::Search-->
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																<thead class="border-bottom border-gray-200 fs-7 fw-bold">
																	<tr class="text-start text-muted text-uppercase gs-0">
																		<th class="min-w-100px"><?php echo $subOrContent; ?> Adı</th>
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<?php if ($subOrContent == "Alt Konu") {
																		$subTopics->showSubTopicsListForTopicDetail($slug);
																	} else {
																		$subTopics->showContentsListForTopicDetail($slug);
																	} ?>
																</tbody>
																<!--end::Table body-->
															</table>
									...
									<div class="modal fade" id="kt_modal_update_customer" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												<!--begin::Form-->
												<?php $topics->updateOneTopic($slug); ?>
												<!--end::Form-->
											</div>
										</div>
									</div>
		...
		<script src="assets/js/custom/apps/topic-details/view/add-payment.js"></script>
